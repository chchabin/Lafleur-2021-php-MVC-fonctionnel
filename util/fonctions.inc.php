...
class Util
{
     ...
     */
    public static function valideAjouterAuPanier($idProduit):bool
    {
    ...
    public static function ajouterQuantites($qtProduits)
    {
        foreach ($qtProduits as $unProduit) {
            if ($unProduit != 'uc' || $unProduit != 'action') {
     ...
     * @return : le tableau
     */
    public static function getLesIdProduitsDuPanier()
    {
     ...
     * @return : le nombre
     */
    public static function nbProduitsDuPanier()
    {
        $n = 0;
        if (isset($_SESSION['produits'])) {
     ...
     * @param $idProduit : identifiant de produit
     */
    public static function retirerDuPanier($idProduit)
    {
     ...
     * @return : vrai ou faux
     */
    public static function estUnCp($codePostal)
    {

        return strlen($codePostal) == 5 && self::estEntier($codePostal);
    }
    ...
    public static function estEntier($valeur)
    {
     ...
     * @return : vrai ou faux
     */
    public static function estUnMail($mail)
    {
     ...
     */
    public static function getErreursSaisieCommande($nom, $rue, $ville, $cp, $mail)
    {
        $lesErreurs = array();
        if ($nom == "") {
